...
- **Semantic model**: This is the part of the knowledgebase that is used to infer new information. It is a set of rules in which the semantic concepts are defined, and the desired results are formulated.
...
## Using a semantic model to create inferences
...
It is possible to select and directly apply an existing semantic model without further editing or changes. Clicking `Browse all models` shows the semantic models, which are already within the knowledgebase and can be used directly.

If you want to create a new semantic model, click the `+` icon at the beginning of the list. A documentation how to develop a new semantic model or edit an existing one is available in Section *Semantic model development* (\@ref(semantic_model_development)).
